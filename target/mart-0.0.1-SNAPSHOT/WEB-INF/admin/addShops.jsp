...
<form:form
	...
	<div class="col-md-4"><label>Merchant Image </label> <form:input
		path="merchantImage" type="file"/></div>
</div>
<div>
	<div class="col-md-12" style="height:1em"></div>
	<div class="col-md-12" style="height: 25px; color: darkgrey;"
	...
	<div class="col-md-offset-2 col-md-4"><label>Shop Id </label> <form:input
		path="shopId" type="text" required="true" class="form-control"
		placeholder="Shop Id..." /></div>

	<div class="col-md-4"><label>Shop Name </label> <form:input
		path="shopName" type="text" required="true" class="form-control"
		placeholder="Shop Name..." /></div>

<div class="col-md-12" style="height:1em"></div>
	<div class="col-md-offset-2 col-md-4"><label>Shop Location </label> <form:input
		path="shopLocation" type="text" required="true" class="form-control"
		placeholder="longitude,latitude..." /></div>

	<div class="col-md-4"><label>Shop Address </label> <form:input
		path="shopAddress" type="text" required="true" class="form-control"
		placeholder="Shop Address..." /></div>

<div class="col-md-12" style="height:1em"></div>
	<div class="col-md-offset-2 col-md-4"><label>Shop Image </label> <form:input
		path="shopImage" type="file" required="true"/></div>

	<div class="col-md-4"><label>Delevery Type </label> <form:input
		path="deliveryType" type="text" required="true" class="form-control"
		placeholder="Delevery Type..." /></div>

<div class="col-md-12" style="height:1em"></div>
	<div class="col-md-offset-2 col-md-4"><label>Opening Time </label> <form:input
		path="openingTime" type="text" required="true" class="form-control"
		placeholder="Opening Time..." /></div>

	<div class="col-md-4"><label>Closing Time</label> <form:input
		path="closingTime" type="text" required="true" class="form-control"
		placeholder="Closing Time..." /></div>

<div class="col-md-12" style="height:1em"></div>
	<div class="col-md-offset-2 col-md-4"><label>Shop Type </label> <form:input
