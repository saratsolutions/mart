...
<center><strong class="boldcapitalize">New Orders</strong></center>
</h3>
</div>
				...
				<td colspan="6" style="height:100%">
					<div id="ordery${order.orderId}" style="display:none;background-color:#5f5f5f;height:2em;color:white;width:95%;border:1px solid orange">
						...
						<div class="col-md-12" style="height:3em">
							<a href="dispatch.htm?id=${order.orderId}"><button class="btn btn-primary">Dispatch Order</button></a>
							<a href="rejectOrder.htm?id=${order.orderId}"><button class="btn btn-primary">Reject Order</button></a>
						</div>
					</div>
				</td>
			</tr>
