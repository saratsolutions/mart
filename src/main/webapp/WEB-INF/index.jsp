...
<c:set var="contextPath" value="${pageContext.request.contextPath}"/>
				<form:form class="login100-form validate-form" action="${contextPath}/index.htm" >
				<div><form:errors path="*"  style="color:red;font-size:14px;" /></div>
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Mobile/Email</span>
						<form:input path="merchantId" class="input100" type="text" required="true"/>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<form:input path="password" class="input100" type="password" required="true"/>
						<span class="focus-input100"></span>
					</div>
...
sarat<img alt="s" src="/resources/img_avatar3.png">
</body>
</html>
