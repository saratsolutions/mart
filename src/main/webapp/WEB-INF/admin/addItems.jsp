...
<center><strong>Add Items </strong></center>
</h3>
</div>
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
<form:form class="login100-form validate-form"
	action="/mart/admin/addItems.htm" enctype="multipart/form-data">
	...
	<div class="col-md-12"><label>Item Category</label> <form:select
		class="form-control" path="itemCategoryId" required="true">
		<c:forEach var="category" items="${itemCategories}">
	...
	<div class="col-md-12"><label>Image</label> <form:input
		path="itemImage" type="file" required="true" onchange="ValidateSize(this)" /></div>

	<div class="col-md-12" style="height: 1em; color: red;"></div>

	<div class="container-login100-form-btn" align="center"><input
		type="submit" value="Add Item" class="btn btn-default"></input></div>
	<br>
</form:form></div>
</div>
</div>
