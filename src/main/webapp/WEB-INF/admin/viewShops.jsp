...
<div class="w3-card-4"  style="width:100%;float:left;margin-right:30px">
    ...
    <div class="col-md-6" style="float:left;padding-left:2em">
    ...
    <div class="col-md-3" style="float:left;padding-left:2em">
    <hr>
     <b>Merchant Address</b><br>
      	...
      	${shop.mailid}<br>
      	<!-- 
      	<p><button href="#" class="btn btn-default">&nbsp;&nbsp;Edit Details&nbsp;&nbsp;</button></p>
      	 -->
      	<p><a href="manageItems.htm?shopId=${shop.shopId}"><button class="btn btn-default">Manage Items</button></a></p>
      	<p><a href="orderHistory.htm?shopId=${shop.shopId}">
