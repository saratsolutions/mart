...
<h3 style="color: white; padding-left: 3em">Welcome</h3>
</div> 
...
<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li>
							<a class="" style="cursor:pointer" onclick="openSubmenu('shops');">Shops<span class="caret"></span></a>				
							<li class="shops"><a href="viewShops.htm">View Shops</a></li>
							<li class="shops"><a href="addShops.htm">Add Shops</a></li>
						</li>
						<li>
							...
							<li class="items"><a href="addItems.htm">Add Items</a></li>
							<li class="items"><a href="viewItemCategories.htm">Manage Item Categories</a></li>
						</li>
