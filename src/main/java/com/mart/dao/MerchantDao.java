...
public class MerchantDao {
	...
	private static String query_add_shop = "insert into t_shops(C_SHOP_ID,C_SHOPNAME,C_LOCATION,C_ADDRESS,C_MERCHANT_ID,C_SHOP_PIC,C_DELEVERY_TYPE,C_OPENING_TIME,C_CLOSING_TIME,C_SHOPTYPE) values(?,?,?,?,?,?,?,?,?,?);";
		...
		log.info("merchant.getPassword:::"+merchant.getPassword());
			try {
				...
				int j = jdbcTemplate.update(query_add_shop,
					...
					/*C_SHOP_ID,C_SHOPNAME,C_LOCATION,C_ADDRESS,C_MERCHANT_ID,C_SHOP_PIC,C_DELEVERY_TYPE,C_OPENING_TIME,C_CLOSING_TIME,C_SHOPTYPE*/
							@Override
							public void setValues(PreparedStatement ps)
									throws SQLException {
								int index = 0;
								ps.setString(++index, merchant.getShopId());
